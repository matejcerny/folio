...
| # | Decision | Status |
|---|---|---|
| [0001](0001-absent-sorts-last.md) | `Absent` sorts after present values in **both** directions; drivers emit explicit `NULLS LAST` rather than trusting dialect defaults | Accepted |
