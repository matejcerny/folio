...
See examples for:
- [Keyset pagination](example/src/main/scala/example/KeysetExample.scala)
- [Offset pagination](example/src/main/scala/example/OffsetOnlyExample.scala)

Work-in-progress integrations with:
- http layer:
  - Tapir
  - http4s
- database layer:
